...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/JamendoR?color=brightgreen)](https://cran.r-project.org/package=JamendoR)
...
knitr::include_graphics('man/figures/JamendoR_auth_screenshot.PNG')
```
